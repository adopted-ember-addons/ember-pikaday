...
var openDatepicker = function(element) {
  ...
  return {
    selectorForMonthSelect: element + ' .pika-lendar:visible .pika-select-month',
    selectorForYearSelect: element + ' .pika-lendar:visible .pika-select-year',
    ...
    selectDate: function(date) {
      ...
      triggerNativeEvent($(element + ' td[data-day="' + day + '"] button:visible')[0], selectEvent);
    },
    selectedDay: function() {
      return $(element + ' .pika-single td.is-selected button').html();
    },
